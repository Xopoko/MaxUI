...
/// The MScrollView is a Componentable struct that provides a customisable scrolling view.
public struct MScrollView: Componentable, DeclarativeCommon {
    ...
    /// Initialise an `MScrollView` with the model, appearance, and refresh control.
    ///
    /// - Parameters:
...
/// behaviour to implement MText appearance. To do this, you need to define the MScrollView
