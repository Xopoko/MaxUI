...
extension String {
    ...
    public func strikethroughStyle(_ strikethroughStyle: NSUnderlineStyle) -> NSAttributedString {
        NSAttributedString(string: self, attributes: [.strikethroughStyle: strikethroughStyle.union(.single).rawValue])
    }
    
    @discardableResult
    public func underlineStyle(_ underlineStyle: NSUnderlineStyle) -> NSAttributedString {
        NSAttributedString(string: self, attributes: [.underlineStyle: underlineStyle.union(.single).rawValue])
    }
    ...
    @discardableResult
    public func baseWritingDirection(_ baseWritingDirection: NSWritingDirection) -> NSAttributedString {
        let paragraph = NSMutableParagraphStyle()
    ...
    @discardableResult
    public func allowsDefaultTighteningForTruncation(_ allowsDefaultTighteningForTruncation: Bool) -> NSAttributedString {
        let paragraph = NSMutableParagraphStyle()
    ...
    @discardableResult
    public func lineBreakStrategy(_ lineBreakStrategy: NSParagraphStyle.LineBreakStrategy) -> NSAttributedString {
        let paragraph = NSMutableParagraphStyle()
...
fileprivate extension NSAttributedString {
    func set(
        ...
        mutable.addAttributes(
            attributes,
            range: NSMakeRange(.zero, (string as NSString).length)
        )
        return mutable
    }
