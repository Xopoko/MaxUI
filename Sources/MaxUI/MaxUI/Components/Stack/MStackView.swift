...
/// This protocol helps other components that want to use MStackView's declarative behavior to implement MText apperance. To do this, you need to define the MStackView appearance in your components.
