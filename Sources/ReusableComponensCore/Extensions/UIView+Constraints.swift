...
extension UIView {
    ...
    private enum MaximUISides: String, CaseIterable {
        ...
        case heightLessOrEqual, widthLessOrEqual, heightGreaterOrEqual, widthGreaterOrEqual
    ...
    private func fill(
        ...
        case .heightLessOrEqual:
            if let heightLessOrEqual = layout.heightLessOrEqual {
                let heightConstraint = heightAnchor.constraint(lessThanOrEqualToConstant: heightLessOrEqual)
                heightConstraint.identifier = side.identifier
                heightConstraint.isActive = true
            } else {
                self.constraints
        ...
        case .widthLessOrEqual:
            if let widthLessOrEqual = layout.widthLessOrEqual {
                let widthConstraint = widthAnchor.constraint(lessThanOrEqualToConstant: widthLessOrEqual)
                widthConstraint.identifier = side.identifier
                widthConstraint.isActive = true
            } else {
                self.constraints
        ...
        case .heightGreaterOrEqual:
            if let heightGreaterOrEqual = layout.heightGreaterOrEqual {
                let heightConstraint = heightAnchor.constraint(greaterThanOrEqualToConstant: heightGreaterOrEqual)
                heightConstraint.identifier = side.identifier
                heightConstraint.isActive = true
            } else {
                self.constraints
        ...
        case .widthGreaterOrEqual:
            if let widthGreaterOrEqual = layout.widthGreaterOrEqual {
                let widthConstraint = widthAnchor.constraint(greaterThanOrEqualToConstant: widthGreaterOrEqual)
                widthConstraint.identifier = side.identifier
                widthConstraint.isActive = true
            } else {
                self.constraints
